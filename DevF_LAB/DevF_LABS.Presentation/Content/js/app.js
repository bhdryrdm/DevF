...
devf = {
    ...
    AjaxHTMLRequest: function (type, data, dataType, url, successFunction, divSelector,errorFunction) {
       
        if (devf.Ine(successFunction)) {
            successFunction = function (returnData) {
                devf.Swal(returnData.ResponseCode, returnData.Message, "warning", "Close");
            }
        }

        if (devf.Ine(errorFunction)) {
            errorFunction = function (returnData) {
                devf.Swal(returnData.status + " - Error", returnData.statusText, "error", "Close");
            }
        }
